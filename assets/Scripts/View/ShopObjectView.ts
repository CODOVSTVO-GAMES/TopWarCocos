...
export class ShopObjectView extends Component {
    ...
    public renderInterface() {
        ...
        let costBuyBarrackAir = ConvertLargeNumber.convert(ConfigPresenter.getPriceBuyBuildingSpawnByTypeAndLevel(TypesObjects.BARRACKS_AIR, levelBuildBarracksAir))
        let costBuyBarrackMarine = ConvertLargeNumber.convert(ConfigPresenter.getPriceBuyBuildingSpawnByTypeAndLevel(TypesObjects.BARRACKS_MARINE, levelBuildBarracksMarine))
        let costBuyBarrackOverland = ConvertLargeNumber.convert(ConfigPresenter.getPriceBuyBuildingSpawnByTypeAndLevel(TypesObjects.BARRACKS_OVERLAND, levelBuildBarracksOverland))
        let costBuyGoldMine = ConvertLargeNumber.convert(ConfigPresenter.getPriceBuyBuildingSpawnByTypeAndLevel(TypesObjects.GOLD_MINE, levelBuildGoldMine))

        let iconBarrackAir = SpriteModel.instance.getObjectSprite(TypesObjects.BARRACKS_AIR, levelBuildBarracksAir)
        let iconBarrackMarine = SpriteModel.instance.getObjectSprite(TypesObjects.BARRACKS_MARINE, levelBuildBarracksMarine)
        let iconBarrackOverland = SpriteModel.instance.getObjectSprite(TypesObjects.BARRACKS_OVERLAND, levelBuildBarracksOverland)
        let iconGoldMine = SpriteModel.instance.getObjectSprite(TypesObjects.GOLD_MINE, levelBuildGoldMine)
        ...
        if (GameModel.instance.coins >= ConfigPresenter.getPriceBuyBuildingSpawnByTypeAndLevel(TypesObjects.GOLD_MINE, levelBuildGoldMine)) {
