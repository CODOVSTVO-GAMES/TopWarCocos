...
export class ModalShopObjectLogic extends Component {
    ...
    private buyBarrackOverland() {
        ...
        TasksGameLogic.instance.checkTask(TypesTasksGame.MERGE_BARRACK_OVERLAND, barrackLevel, 1)
    }
    ...
    private buyBarrackMarine() {
        ...
        GameStorageController.reduceCoins(price)
        SpawnObjectsOnHomeMap.SpawnObjectsOnHomeMapNearby(typeObject, typeLocation, barrackLevel, 1532)
        TasksGameLogic.instance.checkTask(TypesTasksGame.MERGE_BARRACK_MARINE, barrackLevel, 1)
    }
    ...
    private buyBarrackAir() {
        ...
        GameStorageController.reduceCoins(price)
        SpawnObjectsOnHomeMap.SpawnObjectsOnHomeMapNearby(typeObject, typeLocation, barrackLevel, 1532)
        TasksGameLogic.instance.checkTask(TypesTasksGame.MERGE_BARRACK_AIR, barrackLevel, 1)
    }
    ...
    private buyGoldMine() {
        ...
        TasksGameLogic.instance.checkTask(TypesTasksGame.MERGE_GOLD_MINE, mineLevel, 1)
    }
}
