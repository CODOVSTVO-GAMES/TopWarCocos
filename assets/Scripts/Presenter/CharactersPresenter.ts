...
export class CharactersPresenter {
    ...
    static addExperience(value: number, index: number) {
        ...
        let targetExperience = ConfigStorageController.getHeroLevelExpirienceByTypeAndLevel(CharactersModel.instance.characters[index].type, this.getLevel(index) + 1);
        while (this.getExperience(index) > targetExperience) {
            if (this.getExperience(index) > targetExperience) {
                ...
                targetExperience = ConfigStorageController.getHeroLevelExpirienceByTypeAndLevel(CharactersModel.instance.characters[index].type, this.getLevel(index) + 1);
            }
        }
